<template>
  <div>
    <!-- Hero — Allen Coral Atlas-inspired: bathymetry + tile mosaic + caustics + lava orbs -->
...
<style scoped>
/* ── Allen Coral Atlas-inspired hero: deep ocean + bathymetry + tile mosaic ── */
.hero-section {
  background:
...
.hero-bathymetry {
  ...
  z-index: 0; mix-blend-mode: screen; opacity: 0.85;
...
.lava-orb {
  ...
  mix-blend-mode: screen; opacity: 0.6; z-index: 2;
}
.orb--p1 { width: 560px; height: 560px; top: -180px; left: -120px; background: radial-gradient(circle, rgba(34,211,238,0.7) 0%, rgba(34,211,238,0) 70%); animation: lavaA 11s ease-in-out infinite; }
.orb--p2 { width: 480px; height: 480px; top: -60px; right: -100px; background: radial-gradient(circle, rgba(14,116,144,0.85) 0%, rgba(14,116,144,0) 70%); animation: lavaB 13s ease-in-out infinite; }
.orb--p3 { width: 600px; height: 600px; bottom: -200px; left: 30%; background: radial-gradient(circle, rgba(8,145,178,0.65) 0%, rgba(8,145,178,0) 70%); animation: lavaC 16s ease-in-out infinite; }
.orb--c1 { width: 340px; height: 340px; top: 25%; right: 18%; background: radial-gradient(circle, rgba(255,122,102,0.5) 0%, rgba(255,122,102,0) 70%); animation: lavaD 12s ease-in-out infinite; opacity: 0.45; }
.orb--c2 { width: 260px; height: 260px; bottom: 12%; right: -60px; background: radial-gradient(circle, rgba(245,158,11,0.4) 0%, rgba(245,158,11,0) 70%); animation: lavaA 14s ease-in-out infinite; opacity: 0.4; }
...
.reef-stack { position: relative; height: 380px; z-index: 4; }
...
@media (prefers-reduced-motion: reduce) {
  .lava-orb, .reef-card, .hero-caustics, .hero-bathymetry { animation: none; }
}
</style>
